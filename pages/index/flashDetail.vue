<template>
	<view class="wrap">
		...
		<view class="detail-list" :style="{paddingTop:'126rpx'}">
			<view class="ul" v-if="!noData">
				<view class="li" v-for="item in detailList">
					...
					<view class="name">转换时间<text class="text">{{item.createTime}}</text></view>
	...
	export default {
		...
		methods: {
			...
			getDetail() {
				...
				//明细
				uni.request({
					url: this.$httpUrl("/app/about/capital/financialFlowAllList"),
					data: {
