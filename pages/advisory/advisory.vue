  ...
  <view class="wrap wrap-tab" :class="{'yellow-theme':isYellow}">
     <!-- <view class="navbar" >
	  <view class="input-wrap">
		  <template>
		  <input type="text" v-model="keyword" value="" confirm-type="search" @confirm="toSearchNews"  placeholder="请输入搜索内容" class="input">
		   </template>
		  <image src="/static/ic_search@2x.png" class="search"  @tap="toSearchNews" mode="aspectFit"></image>
		  </view>
          </view> -->
